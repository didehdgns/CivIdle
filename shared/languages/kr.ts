export const KR = {
   ...
   FirstTimeTutorialWelcome3HTML:
      "이제 겜의 모든 기본 사항을 알게 되었으니 제국을 건설 할 수 있습니다. 하지만 제가 당신을 보내기 전에, <b>플레이어 정보를 선택</b>하고 게임 내 채팅에서 인사해보세요. 우리는 놀라운 정도의 유용한 정보를 얻을 수 있는 채팅 커뮤니티가 있습니다: 길을 잃었을때 주저하지 말고 물어보세요!",
   Fish: "물고기",
   FishPond: "물고기 연못",
