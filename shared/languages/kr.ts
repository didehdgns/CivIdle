export const KR = {
   ...
   Apartment: "아파트",
   Aphrodite: "아프로디테",
   AphroditeDescV2: "20레벨 이상의 건물을 업그레이드 시 레벨 당 건축가 수송 용량 +1. 이번 제국에서 해금된 모든 고전 시대 영구 위인 레벨 +1",
   ...
   LouvreDesc: "환생시 추가 위인 10명당 자금 해제된 모든 시대의 위인이 한 명 씩 탄생합니다.",
   Lumber: "목재",
   LumberMill: "제재소",
   ...
   MausoleumAtHalicarnassusDescV2: "2타일 범위 내 건물은 모든 운송은 노동자가 필요하지 않습니다.",
   MaxExplorers: "최대 탐험가",
   ...
   RockefellerCenterChristmasTreeDesc: "잠금 해제된 시대마다 행복도 +3이 추가 됩니다. 이 자원 원더는 12월에만 발견 됩니다. ",
   Rocket: "로켓",
   RocketFactory: "로켓 공장",
   Rocketry: "로켓공학",
   Roman: "로마",
   ...
   SantaClausVillageDesc: "완성시, 현 시대 위인 한 명이 탄생 합니다. 이 불가사의는 업그레이드 할 수 있으며, 업그레이드 할 때 마다 위인 한 명을 추가로 생성 됩니다. 이 불가사의로 인한 위인 선택시 4명의 위인 중 한 명을 선택하여 고를 수 있습니다. 이 불가사의는 12월에만 발견 됩니다.",
